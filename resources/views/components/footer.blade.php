    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="border-t border-gray-100 pt-8 flex flex-col md:flex-row justify-between items-center gap-4">
            ...
            <div class="flex gap-6">
                <span class="text-sm text-gray-400 font-medium">Highlow</span>
                <span class="text-sm text-gray-400 font-medium">Boosst</span>
                <span class="text-sm text-gray-400 font-medium">emajine</span>
                <span class="text-sm text-gray-400 font-medium">manthul</span>
                <span class="text-sm text-gray-400 font-medium">GlowUP</span>
            </div>
        </div>
    </div>
</footer>
