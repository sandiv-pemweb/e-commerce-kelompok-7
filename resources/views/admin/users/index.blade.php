            ...
            <div class="bg-white overflow-hidden shadow-lg rounded-2xl mb-8 border border-gray-100">
                <div class="p-6">
                    <form method="GET" action="{{ route('admin.users.index') }}"
                        ...
                        <button type="submit"
                            class="px-6 py-2 bg-brand-dark text-white font-bold rounded-xl hover:bg-brand-orange transition-colors shadow-md">
                            Filter
                        </button>
                        <a href="{{ route('admin.users.index') }}"
                            class="px-6 py-2 bg-gray-100 text-gray-700 font-bold rounded-xl hover:bg-gray-200 transition-colors text-center">
                            Reset
                        </a>
                    </form>
                </div>
