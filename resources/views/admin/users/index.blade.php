                ...
                <div class="p-8">
                    <form method="GET" action="{{ route('admin.users.index') }}" class="flex flex-col md:flex-row gap-4 items-end">
                        <div class="w-full md:w-1/3">
                            ...
                            <input type="text" name="q" id="search" value="{{ request('q') }}" placeholder="Nama atau email..." class="w-full border-gray-200 focus:border-brand-orange focus:ring-brand-orange rounded-xl shadow-sm bg-gray-50/50">
                        </div>
                         <div class="w-full md:w-1/4">
                            <label for="role" class="block font-bold text-sm text-gray-700 mb-2">Role</label>
                            <select name="role" id="role" class="w-full border-gray-200 focus:border-brand-orange focus:ring-brand-orange rounded-xl shadow-sm cursor-pointer bg-gray-50/50">
                        ...
                        <div class="w-full md:w-auto flex gap-3">
                            ...
                            <a href="{{ route('admin.users.index') }}" class="px-6 py-2.5 bg-white border border-gray-200 text-gray-700 font-bold rounded-xl hover:bg-gray-50 transition-colors">
                                Reset
                            </a>
                        </div>
                    </form>
                        ...
                        <table class="min-w-full">
                            <thead>
                                <tr class="border-b border-gray-100">
                                    <th class="px-6 py-4 text-left text-xs font-bold text-gray-400 uppercase tracking-wider pl-4">Pengguna</th>
                                    <th class="px-6 py-4 text-left text-xs font-bold text-gray-400 uppercase tracking-wider">Role</th>
                                    <th class="px-6 py-4 text-left text-xs font-bold text-gray-400 uppercase tracking-wider">Toko</th>
                                ...
                                @foreach ($users as $user)
                                    <tr class="hover:bg-blue-50/50 transition-colors duration-200 group">
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium pr-4">
                                            <a href="{{ route('admin.users.show', $user) }}" class="inline-flex items-center px-4 py-2 bg-white border border-gray-200 rounded-xl text-sm font-bold text-gray-700 hover:bg-brand-dark hover:text-white hover:border-brand-dark transition-all shadow-sm group-hover:shadow-md">
                                                Detail
                                            </a>
                                        </td>
                                    </tr>
