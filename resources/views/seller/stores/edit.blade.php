            ...
            <div class="bg-white overflow-hidden shadow-lg rounded-2xl border border-gray-100">
                <div class="p-8">
                    <form method="POST" action="{{ route('seller.stores.update') }}" enctype="multipart/form-data" class="space-y-8">
                        ...
                        <!-- Store Identity -->
                        <div>
                            <h3 class="text-xl font-serif font-bold text-brand-dark mb-6 border-b border-gray-100 pb-4">Identitas Toko</h3>
                        ...
                        <!-- Location & Address -->
                        <div>
                            <h3 class="text-xl font-serif font-bold text-brand-dark mb-6 border-b border-gray-100 pb-4">Lokasi & Alamat</h3>
                        ...
                        <!-- Bank Information -->
                        <div>
                            <h3 class="text-xl font-serif font-bold text-brand-dark mb-6 border-b border-gray-100 pb-4">Informasi Bank</h3>
