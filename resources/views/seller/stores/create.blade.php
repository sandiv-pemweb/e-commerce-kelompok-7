        ...
        <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="mb-8 text-center">
                ...
                <p class="mt-2 text-gray-500 max-w-2xl mx-auto">Mulai perjalanan Anda sebagai penjual di platform kami.
                    Isi detail di bawah ini untuk membuat toko Anda dan menjangkau lebih banyak pelanggan.</p>
            </div>
                    ...
                    <form method="POST" action="{{ route('seller.stores.store') }}" enctype="multipart/form-data"
                        ...
                        <div>
                            ...
                            <div>
                                ...
                                <div
                                    class="mt-1 flex flex-col items-center justify-center px-6 pt-5 pb-6 border-2 border-gray-300 border-dashed rounded-xl hover:border-brand-orange transition-colors">


                                    <img id="logo-preview" src="#" alt="Logo Preview"
                                        class="h-32 w-32 object-cover rounded-xl shadow-md mb-4 hidden">
                                    ...
                                    <div class="flex text-sm text-gray-600">
                                        <label for="logo"
                                            ...
                                            <input id="logo" name="logo" type="file" class="sr-only" accept="image/*"
                                                required onchange="previewLogo(this)">
                                        </label>
                                    </div>
