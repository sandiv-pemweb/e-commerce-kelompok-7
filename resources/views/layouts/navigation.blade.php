            ...
            <div class="flex">
                ...
                <div class="shrink-0 flex items-center gap-3">
                    <a href="{{ route('home') }}" class="flex items-center gap-2">
                        <div class="hidden md:flex w-10 h-10 bg-brand-orange rounded-lg items-center justify-center text-white">
            ...
            <div class="flex items-center gap-2 md:gap-6">
                ...
                @auth
                    ...
                    <a href="{{ route('wishlist.index') }}"
                        ...
                        <span class="wishlist-count absolute top-1 right-0 inline-flex items-center justify-center px-1.5 py-0.5 text-xs font-bold leading-none text-white transform translate-x-1/4 -translate-y-1/4 bg-brand-orange rounded-full"
                    ...
                    <a href="{{ route('cart.index') }}"
                        ...
                        <span class="cart-count absolute top-1 right-0 inline-flex items-center justify-center px-1.5 py-0.5 text-xs font-bold leading-none text-white transform translate-x-1/4 -translate-y-1/4 bg-brand-orange rounded-full"
                ...
                @else
                    <div class="flex items-center gap-3 pl-4 border-l border-gray-200">
                        <!-- Desktop: Log in text -->
                        <a href="{{ route('login') }}"
                            class="hidden md:inline text-sm font-semibold text-brand-dark hover:text-brand-orange">Log in</a>
                        
                        <!-- Mobile: Log in button -->
                        <a href="{{ route('login') }}"
                            class="md:hidden px-4 py-2 text-sm font-bold text-white bg-brand-dark rounded-lg hover:bg-brand-orange transition-colors shadow-sm">Log In</a>

                        <!-- Register: Hidden on mobile -->
                        <a href="{{ route('register') }}"
                            class="hidden md:inline-flex px-4 py-2 text-sm font-semibold text-white bg-brand-dark rounded-lg hover:bg-brand-orange transition-colors">Register</a>
                    </div>
                @endauth
            </div>
        </div>
