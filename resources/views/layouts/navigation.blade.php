<nav x-data="{ open: false }" class="bg-white border-b border-gray-100 shadow-sm sticky top-0 z-50">
        ...
        <div class="flex justify-between h-20">
                ...
                <div class="shrink-0 flex items-center gap-3">
                    <a href="{{ route('home') }}" class="flex items-center gap-2">
                        ...
                        <div class="flex flex-col">
                            ...
                            <span class="text-xs text-brand-muted font-medium">Dashboard</span>
                        </div>
                    </a>
                </div>
            ...
            <div class="-me-2 flex items-center sm:hidden">
                <button @click="open = ! open"
                    class="inline-flex items-center justify-center p-2 rounded-md text-gray-400 hover:text-brand-orange hover:bg-orange-50 focus:outline-none focus:bg-orange-50 focus:text-brand-orange transition duration-150 ease-in-out">
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden bg-white border-t border-gray-100">
        <div class="pt-2 pb-3 space-y-1">
            <x-app-navigation-links :responsive="true" />
        </div>
        ...
        <div class="pt-4 pb-1 border-t border-gray-200">
            <div class="px-4 flex items-center gap-3">
                ...
                <div>
                    <div class="font-bold text-base text-brand-dark">{{ Auth::user()->name }}</div>
            ...
            <div class="mt-3 space-y-1">
                <x-responsive-nav-link :href="route('profile.edit')"
                    class="hover:text-brand-orange hover:bg-orange-50 hover:border-brand-orange">
                    {{ __('Profile') }}
                ...
                <form method="POST" action="{{ route('logout') }}">
                    ...
                    <x-responsive-nav-link :href="route('logout')"
                        class="hover:text-brand-orange hover:bg-orange-50 hover:border-brand-orange" onclick="event.preventDefault();
                                        this.closest('form').submit();">
                        {{ __('Log Out') }}
                    </x-responsive-nav-link>
                </form>
