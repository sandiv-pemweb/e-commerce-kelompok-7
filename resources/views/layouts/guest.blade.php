    ...
    <div class="min-h-screen flex flex-col sm:justify-center items-center py-6 sm:py-12 px-4">
        <div class="mb-8">
            <a href="{{ route('home') }}" class="flex items-center gap-3">
                <div
                    class="w-12 h-12 bg-brand-orange rounded-xl flex items-center justify-center text-white shadow-lg shadow-brand-orange/20">
        ...
        <div
            class="w-full sm:max-w-md mt-6 px-8 py-8 bg-white shadow-xl shadow-gray-100 overflow-hidden rounded-2xl border border-gray-100">
            {{ $slot }}
        </div>
    </div>
</body>
