    ...
    <section class="relative bg-white overflow-hidden">
            ...
            <div class="relative z-10 pb-8 bg-white sm:pb-16 md:pb-20 lg:max-w-2xl lg:w-full lg:pb-28 xl:pb-32">
                <main class="mt-10 mx-auto max-w-7xl px-4 sm:mt-12 sm:px-6 md:mt-16 lg:mt-20 lg:px-8 xl:mt-28">
                    <div class="sm:text-center lg:text-left">
                        ...
                        <p
                            class="mt-2 text-base text-gray-500 sm:mt-5 sm:text-lg sm:max-w-xl sm:mx-auto md:mt-5 md:text-xl lg:mx-0">
        ...
        <div class="lg:absolute lg:inset-y-0 lg:right-0 lg:w-1/2 bg-brand-orange/10 rounded-bl-[100px] overflow-hidden">
            <div class="relative h-56 w-full sm:h-72 md:h-96 lg:h-full flex items-center justify-center">
                <!-- Decorative Circles -->
                <div
                    class="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-[500px] h-[500px] bg-brand-orange rounded-full opacity-20 blur-3xl">
                </div>
                <div
                    class="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-[300px] h-[300px] bg-brand-orange rounded-full opacity-40">
                </div>

                <!-- Hero Image Placeholder -->
                <img class="relative z-10 h-full w-full object-cover object-center lg:object-contain p-10"
                ...
                <!-- Floating Card -->
                <div
                    class="absolute bottom-20 right-20 bg-white p-4 rounded-xl shadow-lg z-20 hidden lg:flex items-center gap-4 max-w-xs">
                ...
                @foreach($products as $product)
                    <div class="bg-white rounded-2xl shadow-sm hover:shadow-md transition-shadow overflow-hidden group">
                        <div class="relative aspect-[2/3] bg-gray-200 overflow-hidden">
                            <img src="{{ $product->image_url ?? 'https://via.placeholder.com/300x450' }}"
                                alt="{{ $product->name }}"
                            ...
                            <div class="absolute top-2 right-2">
                                ...
                                @else
                                    <a href="{{ route('login') }}"
                                        class="p-2 bg-white/80 backdrop-blur-sm rounded-full text-gray-400 hover:text-red-500 transition-colors">
